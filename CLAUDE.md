...
│                           refColWidth = computeRefColWidth(commits), clamped 120–240px
│                           from the widest first chip, passed to CommitRow AND WipRow so
│                           the WIP banner stays aligned; empty state offers "Clear
...
│                           icon) reserving room for the "+n" badge — never truncate a
│                           label to "H…"; merge-commit summaries are text-muted unless
